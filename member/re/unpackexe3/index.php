...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/856359182038597672/image1.gif"><br><br><br/><br/><br/><br/><br/>
<a href="crackmetoronto3.exe" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{6<!$5f74g}" || $_POST['flag'] == "6<!$5f74g"){
