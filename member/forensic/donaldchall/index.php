...
<center>
<img src="https://cdn.discordapp.com/attachments/858820849364369438/861164704616808468/image0.gif"><br><br><br/><br/><br/><br/><br/>
<a href="inject.bin" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{ru883r_ducky_d3c0d3_15_ea5y}" || $_POST['flag'] == "ru883r_ducky_d3c0d3_15_ea5y"){
