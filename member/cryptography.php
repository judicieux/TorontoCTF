...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Cryptography</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="card-block">
                <?php
                if(strpos(file_get_contents("crypto/md4/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/md4" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">MD4<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/md4" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">MD4<br/><code>5 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/md5/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/md5" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">MD5<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/md5" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">MD5<br/><code>5 Points</code></button></a>';
                }
			  if(strpos(file_get_contents("crypto/burp/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/burp" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Burp<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/burp" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Burp<br/><code>5 Points</code></button></a>';
                }
				if(strpos(file_get_contents("crypto/sha1/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/sha1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Sha128<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/sha1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Sha128<br/><code>5 Points</code></button></a>';
                }
				if(strpos(file_get_contents("crypto/sha224/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/sha224" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Sha224<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/sha224" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Sha224<br/><code>5 Points</code></button></a>';
                }
				if(strpos(file_get_contents("crypto/sha2/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/sha2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Sha256<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/sha2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Sha256<br/><code>5 Points</code></button></a>';
                }
                 if(strpos(file_get_contents("crypto/negcaesar/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/negcaesar" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Neg Caesar<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/negcaesar" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Neg Caesar<br/><code>5 Points</code></button></a>';
                }
		        if(strpos(file_get_contents("crypto/vigeneresquare/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/vigeneresquare" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">VigenereSquare<br/><code>10 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/vigeneresquare" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">VigenereSquare<br/><code>10 Points</code></button></a>';
                }
                 if(strpos(file_get_contents("crypto/md5salt/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/md5salt" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">MD5Salt<br/><code>15 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/md5salt" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">MD5Salt<br/><code>15 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/babyxor/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/babyxor" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">BabyXor<br/><code>20 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/babyxor" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">BabyXor<br/><code>20 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/rsabag/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/rsabag" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">RSA Bag<br/><code>60 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/rsabag" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">RSA Bag<br/><code>60 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/breakaes/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/breakaes" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Break AES<br/><code>70 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/breakaes" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Break AES<br/><code>70 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/rsatricks/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/rsatricks" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">RSATricks<br/><code>75 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/rsatricks" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">RSATricks<br/><code>75 Points</code></button></a>';
                }
                if(strpos(file_get_contents("crypto/xorpermutation/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="crypto/xorpermutation" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">XOR Permutation<br/><code>120 Points</code></button></a>'; 
                } else {
                    echo '<a href="crypto/xorpermutation" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">XOR Permutation<br/><code>120 Points</code></button></a>';
                }
