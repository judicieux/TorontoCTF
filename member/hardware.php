                                ...
                                <div class="main-menu-header">
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            if(!empty($row['avatar'])){
                                    ?>
                                    <img class="img-80 img-radius" src="avatars/<?php echo $row['avatar']; ?>" alt="User-Profile-Image" width="20" height="55" style='object-fit: cover;'/>
                                    <?php
                                    } else {
                                    ?>
                                    <img class="img-80 img-radius" src="avatars/default.png" alt="User-Profile-Image" width="50" height="40" />
                                    <?php
                                    }
                                    ?>
                                    <?php
...
<li class="">
            ...
            <div class="card-block">
                ...
                if(strpos(file_get_contents("hardware/punchcard/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="hardware/punchcard" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Punchcard<br/><code>10 Points</code></button></a>'; 
                } else {
                    echo '<a href="hardware/punchcard" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Punchcard<br/><code>10 Points</code></button</a>';
                }
