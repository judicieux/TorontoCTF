...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/860321181864951819/image0.gif"><br><br><br/><br/><br/><br/><br/>
<h3 style="color:white">00382426df113d90f2cd11b15cc7390a</h3>
<h3 style="color:white">Salt: toronto</h3><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{whatissleep}" || $_POST['flag'] == "whatissleep"){
