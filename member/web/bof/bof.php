...
<center><img src="https://i.skyrock.net/2659/95822659/pics/3265980550_1_7_5TzAaVa3.gif"/></center><br/><br/><br/><br/><br/>
<?php

    $host = "mysql-bofbased.alwaysdata.net";
    $user_mysql = "bofbased";
    $password_mysql = "Kaka123.";
    $database = "bofbased_bofbased";
    $conn = mysqli_connect($host, $user_mysql, $password_mysql, $database) or die("error");
    ...
    if(!empty($_GET["id"])){
        ...
        if(strlen($query) <= 200){
            echo "<center><h4 style='color:white'>Toronto</h4></center>";
        } else {
            $success = mysqli_query($conn, $query);
            if(mysqli_num_rows($success)) {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{B0f_0v3R_Sql1_WTF}" || $_POST['flag'] == "B0f_0v3R_Sql1_WTF"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+50 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 50 WHERE username = '" . $_SESSION["username"] . "'";
