...
<center>
<img src="https://cdn.discordapp.com/attachments/851138641564401725/851141299965001770/2020.08.25-12.27-boundingintocomics-5f445b03367e0.png"><br><br><br/><br/><br/><br/><br/>
<a href="index.png" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{PUNCHC4RDMASTERR34D3R}" || $_POST['flag'] == "PUNCHC4RDMASTERR34D3R"){
