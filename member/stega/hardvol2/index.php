...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/864842942085857280/image0.gif"><br><br><br/><br/><br/><br/><br/>
<a href="zzZZ.zip"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{H4444444RD_V0007_2_IS_57R0N6}" || $_POST['flag'] == "H4444444RD_V0007_2_IS_57R0N6"){
