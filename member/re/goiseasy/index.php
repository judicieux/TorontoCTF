...
<center>
<img src="https://cdn.discordapp.com/attachments/860518606369325086/861615558113755166/eva.gif"><br><br><br/><br/><br/><br/><br/>
<a href="crackme.exe"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{g0l4ngM4st3r}" || $_POST['flag'] == "g0l4ngM4st3r"){
