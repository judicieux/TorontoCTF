...
<center>
<img src="https://images-ext-1.discordapp.net/external/R3bFBMBAdAQJgZbT_6U1i6EOVCPNUIq3uvgQe8o9gdo/http/reve-of-manga.r.e.pic.centerblog.net/49cf3d33.gif"><br><br><br/><br/><br/><br/><br/>
<h3 style="color:white"></h3>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{X0r_Kn0wn_pl4inT3xt}" || $_POST['flag'] == "X0r_Kn0wn_pl4inT3xt"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+20 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 20 WHERE username = '" . $_SESSION["username"] . "'";
