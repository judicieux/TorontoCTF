...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/863887128576524328/7O3T.gif"><br><br><br/><br/><br/><br/><br/>
<a href="PIT.png"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{zzzZZPITMETHODis3Z}" || $_POST['flag'] == "zzzZZPITMETHODis3Z"){
