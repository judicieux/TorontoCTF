...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    extract($_POST);
    if (isset($password) && $password == 't0r0nt0_ch4ll{eZ_3x7r4c7_BYp4SS}') {
        $log = true;
    }
}
?>
...
<center>
<form method="post">
        <h6 style="color:white">by 150k</h6>
        <img src="https://media.discordapp.net/attachments/830544843976998942/831619849594732604/mp4.gif"/><br><br><br/><br/>
        <h4 style="color:white">Password</h4>
        <input type="password" name="password"/><br/>
        <input type="submit" class="btn btn-primary" value="Go"/><br><br>
        <input type="submit" class="btn btn-primary" name="code" value="Code Source"/>
</form>
<center>

    <?php if ($log) { ?>
        Nice, flag : t0r0nt0_ch4ll{eZ_3x7r4c7_BYp4SS}
    <?php } ?>
    <?php
    if(!empty($_POST["code"])){
        if(isset($_POST["code"])){
            echo "<script src='https://gist.github.com/g3zb0yy/af78d09fed9e23856662ee703b914b8a.js'></script>";
        }
    }
    ?>
<style>
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{eZ_3x7r4c7_BYp4SS}" || $_POST['flag'] == "eZ_3x7r4c7_BYp4SS"){
