...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/853708664313086012/560e3d83a2136eab78377f646ef2eba4.gif"><br><br><br/><br/><br/><br/><br/>
<a href="t0r0nt0ch4ll3z.png"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{sn0wt0r0nt0}" || $_POST['flag'] == "sn0wt0r0nt0"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+35 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 35 WHERE username = '" . $_SESSION["username"] . "'";
