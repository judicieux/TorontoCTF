...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/859936698582040606/c5861e77f273fc015b839b78fccccdf9b1c03368r1-500-281_hq.gif"><br><br><br/><br/><br/><br/><br/>
<a href="AyooFody.exe" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{c0stur4f0dy4r3n0th4rd}" || $_POST['flag'] == "c0stur4f0dy4r3n0th4rd"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+30 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 30 WHERE username = '" . $_SESSION["username"] . "'";
