                                ...
                                <a href="#!" class="waves-effect waves-light">
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            if(!empty($row['avatar'])){
                                    ?>
                                    <img src="avatars/<?php echo $row['avatar']; ?>" class="img-radius" alt="User-Profile-Image" width="50" height="40" />
                                    <?php
                                    } else {
                                    ?>
                                ...
                                <div class="main-menu-header">
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            if(!empty($row['avatar'])){
                                    ?>
                                    <img class="img-radius img-40 align-top m-r-15" src="avatars/<?php echo $row['avatar']; ?>" alt="User-Profile-Image" width="50" height="60" />
                                    <?php
                                    } else {
                                    ?>
...
<li class="">
                                ...
                                $whitelist = array("g3zb0yy", "ret", "Lochness6");
                                $result = mysqli_query($bdd, $sql);
                                if (mysqli_num_rows($result)) {
                                    while ($row = mysqli_fetch_array($result)) {
...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Web</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <?php
	if(strpos(file_get_contents("web/addmepoints/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/addmepoints/" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Add Me Points<br/><code>5 Points</code></button></a>';   
    } else {
        echo '<a href="web/addmepoints/" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Add Me Points<br/><code>5 Points</code></button></a>';
    }
    if(strpos(file_get_contents("web/union/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/union/union.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi Union<br/><code>10 Points</code></button></a>';   
    } else {
        echo '<a href="web/union/union.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi Union<br/><code>10 Points</code></button></a>';
    }
        if(strpos(file_get_contents("web/extractbypass/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/extractbypass/extract.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">PHP Extract<br/><code>25 Points</code></button></a>';
    } else {
        echo '<a href="web/extractbypass/extract.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">PHP Extract<br/><code>25 Points</code></button></a>';
    }
        if(strpos(file_get_contents("web/xsswaf/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/xsswaf/xsswaf.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">XSS Hard<br/><code>25 Points</code></button></a>'; 
    } else {
        echo '<a href="web/xsswaf/xsswaf.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">XSS Hard<br/><code>25 Points</code></button></a>';
    }

    if(strpos(file_get_contents("web/blind/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/blind/blind.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi Blind<br/><code>30 Points</code></button></a>';
    } else {
        echo '<a href="web/blind/blind.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi Blind<br/><code>30 Points</code></button></a>';
    }
        if(strpos(file_get_contents("web/typejuggling/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/typejuggling/typejuggling.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">PHP Type Juggling<br/><code>45 Points</code></button></a>'; 
    } else {
        echo '<a href="web/typejuggling/typejuggling.php" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">PHP Type Juggling<br/><code>45 Points</code></button></a>';
    }


    if(strpos(file_get_contents("web/time/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/time/time.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi Time<br/><code>50 Points</code></button></a>';
    } else {
        echo '<a href="web/time/time.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi Time<br/><code>50 Points</code></button></a>';
    }

    if(strpos(file_get_contents("web/bof/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/bof/bof.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi BOF<br/><code>50 Points</code></button></a>';
    } else {
        echo '<a href="web/bof/bof.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi BOF<br/><code>50 Points</code></button></a>';
    }
        if(strpos(file_get_contents("web/regex/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/regex/regex.php?regex=" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">PCRE Matcher<br/><code>65 Points</code></button></a>'; 
    } else {
        echo '<a href="web/regex/regex.php?regex=" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">PCRE Matcher<br/><code>65 Points</code></button></a>';
    }

    if(strpos(file_get_contents("web/routed/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/routed/routed.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi Routed<br/><code>90 Points</code></button></a>';
    } else {
        echo '<a href="web/routed/routed.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi Routed<br/><code>90 Points</code></button></a>';
    }

    if(strpos(file_get_contents("web/master/winners.txt"), $_SESSION["username"]) !== false) {
        echo '<a href="web/master/master.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">SQLi Master<br/><code>100 Points</code></button></a>';
    } else {
        echo '<a href="web/master/master.php?id=1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">SQLi Master<br/><code>100 Points</code></button></a>';
    }
