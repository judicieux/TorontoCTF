...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Reverse Engineering</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-header-left">
                                                            <h5>Reverse Engineering Challenges</h5>
                                                        </div>
            ...
            <div class="card-block">
                <?php
                if(strpos(file_get_contents("re/crackisntgood/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/crackisntgood" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">CrackIsntGood<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/crackisntgood" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">CrackIsntGood<br/><code>5 Points</code></button></a>';
                }
			  if(strpos(file_get_contents("re/anyprotection/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/anyprotection" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">NET AnyProtection<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/anyprotection" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">NET AnyProtection<br/><code>5 Points</code></button></a>';
                }
   			   if(strpos(file_get_contents("re/goiseasy/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/goiseasy" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">GoIsEasy<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/goiseasy" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">GoIsEasy<br/><code>5 Points</code></button></a>';
                }
			   if(strpos(file_get_contents("re/unpackexe1/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/unpackexe1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Unpack EXE 1<br/><code>15 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/unpackexe1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Unpack EXE 1<br/><code>15 Points</code></button></a>';
                }
			   if(strpos(file_get_contents("re/illusorysuperiority/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/illusorysuperiority" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Illusory Superiority<br/><code>20 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/illusorysuperiority" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Illusory Superiority<br/><code>20 Points</code></button></a>';
                }
                  if(strpos(file_get_contents("re/unpackexe2/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/unpackexe2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Unpack EXE 2<br/><code>25 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/unpackexe2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Unpack EXE 2<br/><code>25 Points</code></button></a>';
                }
			  if(strpos(file_get_contents("re/pycrev/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/pycrev" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">PYCrev<br/><code>25 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/pycrev" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">PYCrev<br/><code>25 Points</code></button></a>';
                }
				   if(strpos(file_get_contents("re/ayoofody/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/ayoofody" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Unpack EXE 2<br/><code>30 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/ayoofody" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">AyooFody<br/><code>30 Points</code></button></a>';
                }
				if(strpos(file_get_contents("re/unpackexe3/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/unpackexe3" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Unpack EXE 3<br/><code>35 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/unpackexe3" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Unpack EXE 3<br/><code>35 Points</code></button></a>';
                }
                if(strpos(file_get_contents("re/unpackpy/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="re/unpackpy" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Unpack PY<br/><code>40 Points</code></button></a>'; 
                } else {
                    echo '<a href="re/unpackpy" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Unpack PY<br/><code>40 Points</code></button></a>';
                }
