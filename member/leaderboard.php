                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="leaderboard.php"> <i class="fa fa-home"></i> </a>
                                            </li>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover m-b-0 without-header">
                                                                <tbody>
    <?php
    $sql = 'SELECT * FROM users ORDER BY pts DESC';
    $result = mysqli_query($bdd, $sql);
    $rank = 0;
    if (mysqli_num_rows($result)) {
        while ($row = mysqli_fetch_array($result)) {
            if(!empty($row['avatar'])){
                ...
                if($row["pts"] <= 50 && !in_array($row["username"], $whitelist)){
                   echo "<tr>
                            <td>    
								<div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                                <img src='avatars/" . $row['avatar'] . "' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' style='object-fit: cover;'/><br/><img src='https://img.shields.io/badge/Newbie-1ED760?&style=for-the-badge&logoColor=white' width='50px' style='position:relative;left:-3px'><br/><br/></div>
                                <div class='d-inline-block'>
                                <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                }
                if($row["pts"] > 50 && $row["pts"] <= 150 && !in_array($row["username"], $whitelist)){
                    echo "<tr>
                <td>
                    <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                        <img src='avatars/" . $row['avatar'] . "' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' style='object-fit: cover;'/><br/><img src='https://img.shields.io/badge/Challenger-0769AD?style=for-the-badge&logoColor=white' width='70px' style='position:relative;left:-12px'><br/><br/></div>
                        <div class='d-inline-block'>
                        <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                } 
                if($row["pts"] > 150 && !in_array($row["username"], $whitelist)){
                    echo "<tr>
                <td>
                    <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                        <img src='avatars/" . $row['avatar'] . "' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' style='object-fit: cover;'/><br/><img src='https://img.shields.io/badge/Hacker-000000?style=for-the-badge&logoColor=white' width='50px' style='position:relative;left:-3px'><br/><br/></div>
                        <div class='d-inline-block'>
                        <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                } 
                    ...
                    if(in_array($row["username"], $whitelist)){
                            ...
                            <td>
                                <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                                    <img src='avatars/" . $row['avatar'] . "' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' style='object-fit: cover;'/><br/><img src='https://img.shields.io/badge/Admin-E34F26?style=for-the-badge&logoColor=white' width='50px' style='position:relative;left:-3px'><br/><br/></div>
                                    <div class='d-inline-block'>
                                    <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';    
                    }
                ...
                <td>
                    <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                        <img src='avatars/default.png' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' /><br/><img src='https://img.shields.io/badge/Newbie-1ED760?&style=for-the-badge&logoColor=white' width='50px' style='position:relative;left:-3px'><br/><br/></div>
                        <div class='d-inline-block'>
                        <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                    } 
                    if($row["pts"] > 50 && $row["pts"] <= 150 && !in_array($row["username"], $whitelist)){
                ...
                <td>
                    <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                        <img src='avatars/default.png' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' /><br/><img src='https://img.shields.io/badge/Challenger-0769AD?style=for-the-badge&logoColor=white' width='70px' style='position:relative;left:-12px'><br/><br/></div>
                        <div class='d-inline-block'>
                        <h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                    } 
                    if($row["pts"] > 150 && !in_array($row["username"], $whitelist)){
                                $rank++;
                                echo "<tr>
                            <td>
                                <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                                    <img src='avatars/default.png' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' /><br/><img src='https://img.shields.io/badge/Hacker-000000?style=for-the-badge&logoColor=white' width='50px' style='position:relative;left:-3px'><br/><br/></div>
                                    <div class='d-inline-block'>
                                    <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p>';  
                    }
                    ...
                    if(in_array($row["username"], $whitelist)){
                            ...
                            <td>
                                <div class='d-inline-block align-middle'>
<a href='user.php?id=" . $row["id"] . "'>
                                    <img src='avatars/default.png' alt='user image' class='img-radius img-40 align-top m-r-15' width='50' height='40' /><br/><img src='https://img.shields.io/badge/Admin-E34F26?style=for-the-badge&logoColor=white' width='50px'><br/><br/></div>
                                    <div class='d-inline-block'>
                                    <br/><h6>" . $row['username'] . "<p class='text-muted m-b-0'>Place: " . $rank . " <p class='text-muted m-b-0'>Points: " . $row['pts'] . '</p></div>';    
                    }
