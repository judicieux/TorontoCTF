...
<center>
<img src="https://cdn.discordapp.com/attachments/851138629899255808/861622363564277776/7ed5654731c8545c4b3c8135aba7bbbc.gif"><br><br><br/><br/><br/><br/><br/>
<h3 style="color:white">Hi, I wanna be the first on Toronto, could you add me 10000 points please ?</h3><br>
<form method="POST">
    <select name="points">
...
<br><br>
<?php
if(isset($_POST["points"]) && isset($_POST["submit2"]) && !empty($_POST["points"]))
{
    if($_POST["points"] == 10000){
        echo "<center><h5 style='color:green'>GG, you can validate the challenge with: t0r0nt0_ch4ll{ty_4_l0t_f0r_th3_p01nt5_m4t3}</h5></center>";
    } elseif($_POST["points"] != 10000) {
        echo "<center><h3>I said 10000 points....</center</h3>";
    }
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{ty_4_l0t_f0r_th3_p01nt5_m4t3}" || $_POST['flag'] == "ty_4_l0t_f0r_th3_p01nt5_m4t3"){
