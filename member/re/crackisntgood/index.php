...
<center>
<img src="https://media0.giphy.com/media/DRrsJxwyS1Iju/200.gif"><br><br><br/><br/><br/><br/><br/>
<a href="crackme"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{Such4CrackerB0y}" || $_POST['flag'] == "Such4CrackerB0y"){
