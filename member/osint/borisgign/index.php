...
<center>
<img src="https://cdn.discordapp.com/attachments/858820849364369438/858822522644594728/86cdf54dd086959f23a2153ae013ade2.gif"><br><br><br/><br/><br/><br/><br/>
<a href="info.html"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{56ruehirschfeld}" || $_POST['flag'] == "56ruehirschfeld"){
