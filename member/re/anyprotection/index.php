...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/861039387726053386/image0.gif"><br><br><br/><br/><br/><br/><br/>
<a href="anyprotection.exe"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{nopr0t3ct}" || $_POST['flag'] == "nopr0t3ct"){
