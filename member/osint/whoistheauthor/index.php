...
<center>
<img src="https://i.gifer.com/J4Qb.gif"><br><br><br/><br/><br/><br/><br/>
<a href="whoistheauthor.jpg"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{Robert_Myers}" || $_POST['flag'] == "Robert_Myers"){
