...
<!--===============================================================================================-->
  ...
  <link rel="stylesheet" type="text/css" href="/css/anime-main.css">
<!--===============================================================================================-->
</head>
<style>
body {
...
<li class="">
    ...
    $anime = str_replace("/*", "", $_GET["anime"]);
    $anime_final = str_replace("*/", "", $anime);
    $sql = "SELECT * FROM " . $anime_final;
    $sql2 = "SELECT * FROM " . $anime_final . " WHERE episode = 1";
    $query = mysqli_query($bdd, $sql);
            ...
            while($row = mysqli_fetch_array($query)){
                echo '<div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                          ...
                          <button onclick="document.location=' . "'" . "watch.php?anime=" . $_GET["anime"] . "&episode=" . $row["episode"] . "'" . '" name="xxx" class="login100-form-btn">
                            Episode ' . $row["episode"] . '
                          </button>
                        </div>
                      </div>';
