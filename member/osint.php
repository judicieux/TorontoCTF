...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">OSINT</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="card-block">
                <?php
			 if(strpos(file_get_contents("osint/whoistheauthor/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="osint/whoistheauthor" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">WhoIsTheAuthor<br/><code>5 Points</code></button></a>'; 
            } else {
                echo '<a href="osint/whoistheauthor" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">WhoIsTheAuthor<br/><code>5 Points</code></button></a>';
            }
                if(strpos(file_get_contents("osint/tracking/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="osint/tracking" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Tracking<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="osint/tracking" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Tracking<br/><code>5 Points</code></button></a>';
                }
				 if(strpos(file_get_contents("osint/borisgign/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="osint/borisgign" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">BorisGIGN<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="osint/borisgign" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">BorisGIGN<br/><code>5 Points</code></button></a>';
                }
