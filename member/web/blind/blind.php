...
<center><img src="https://media1.tenor.com/images/5e76ff63f664d2a5219b5e1f5698e7ad/tenor.gif?itemid=16633554"/></center><br/><br/><br/><br/><br/>
<?php
            if(!empty($_GET['id']))
            {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{W0w_Y0U_4R3_N0t_Bl1nD}" || $_POST['flag'] == "W0w_Y0U_4R3_N0t_Bl1nD"){
