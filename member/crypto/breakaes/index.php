...
<center>
<img src="https://thumbs.gfycat.com/WebbedSoreFinnishspitz-small.gif" /><br><br/><br/><br/><br/><br/>
<h3 style="color:white">v6DoYyXT7Nys1lMdHTXOtLcqOBDYsMJW|ihkzZOUAidDm2reQ</h3>
<h3 style="color:white">577876455a386f754c4e5755344564726a2b756e6c52515a4f6e397548464c364c656c35335168367841365269513d3d</h3><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{aes_34zy_t0_d3crypt}" || $_POST['flag'] == "aes_34zy_t0_d3crypt"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+70 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 70 WHERE username = '" . $_SESSION["username"] . "'";
