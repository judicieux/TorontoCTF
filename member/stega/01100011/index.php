...
<center>
<img src="https://cdn.discordapp.com/attachments/853685439880757308/854134754336440320/228a4f2b2c62bf3934cb3b0b07eab854.gif"><br><br><br/><br/><br/><br/><br/>
<a href="challenge.jpg"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{bin4rytr4nslat0r}" || $_POST['flag'] == "bin4rytr4nslat0r"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+15 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 15 WHERE username = '" . $_SESSION["username"] . "'";
