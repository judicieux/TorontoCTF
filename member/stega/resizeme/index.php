...
<center>
<img src="https://acegif.com/wp-content/uploads/2020/07/anime-sleep.gif"><br><br><br/><br/><br/><br/><br/>
<a href="resizestegano.png"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{R3SIZ3R_PR0!}" || $_POST['flag'] == "R3SIZ3R_PR0!"){
