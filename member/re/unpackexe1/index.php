...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/859935204976885760/gfdgdf.gif"><br><br><br/><br/><br/><br/><br/>
<a href="unpackiseasy.exe" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{K1n60fUnp4ck1ng}" || $_POST['flag'] == "K1n60fUnp4ck1ng"){
