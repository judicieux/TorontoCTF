...
<img src="https://image.noelshack.com/fichiers/2021/25/6/1624672505-leoqhwn.gif"><br>
<?php
if(isset($_GET['search'])){
    if(!preg_match('/svg|script|onload/is', $_GET['search'])){
        echo $_GET['search'] . "<br/><h2 style='color:red'>try to pop alert()</h3>";
	} else{
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{34zy_XsS_Ch4LL3Ng3}" || $_POST['flag'] == "34zy_XsS_Ch4LL3Ng3"){
