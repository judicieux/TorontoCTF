...
<center>
<img src="https://cdn.discordapp.com/attachments/853685439880757308/853988311181819904/test21.gif"><br><br><br/><br/><br/><br/><br/>
<a href="b3f4st.gif"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        <button name="submit" placeholder="t0r0nt0_ch4ll{flag}" class="button">Submit flag</button>
    </p>
</form>
</center>
        <?php
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{flagiswowyou4r34pr0mym3n}" || $_POST['flag'] == "flagiswowyou4r34pr0mym3n"){
