...
<center>
<img src="https://image.noelshack.com/fichiers/2021/18/5/1620384629-telechargement.gif"><br><br><br/><br/><br/><br/><br/>
<a href="corrupted.jpg"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{JpG_N0t_C00l}" || $_POST['flag'] == "JpG_N0t_C00l"){
