...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/853570551611129866/1512514615-giphy.gif"><br><br><br/><br/><br/><br/><br/>
<a href="UnpackMe2.exe" download><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{unp4ckw1thc0nfus3rc4nb3h4rd}" || $_POST['flag'] == "unp4ckw1thc0nfus3rc4nb3h4rd"){
