...
<center>
<img src="https://media.discordapp.net/attachments/843904865084243968/862514834892914728/image0.gif"><br><br><br/><br/><br/><br/><br/>
<a href="IllusorySuperiority"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{n0t4fl4gbr0!}" || $_POST['flag'] == "n0t4fl4gbr0"){
