...
<center>
<img src="https://cdn.discordapp.com/attachments/851138629899255808/855546761535553586/olkolporiginal.gif"><br><br><br/><br/><br/><br/><br/>
<h3 style="color:white">ebg13vfirelrm</h3>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{rot13isveryez}" || $_POST['flag'] == "rot13isveryez"){
