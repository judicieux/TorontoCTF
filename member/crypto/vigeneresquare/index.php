...
<center>
<img src="https://cdn.discordapp.com/attachments/858820849364369438/858821465616941067/a90fae0eb22f6bb4a6f8580db26e95c8.gif" /><br><br/><br/><br/><br/><br/>
<h3 style="color:white">LISGGBHYMDWTWHFJX</h3>
<h3 style="color:white">Key: SUB.........</h3><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{TORONTOETVIGENERE}" || $_POST['flag'] == "TORONTOETVIGENERE"){
