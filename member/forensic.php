...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Forensic</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="card-block">
				 <?php
                if(strpos(file_get_contents("forensic/donaldchall/winners.txt"), $_SESSION["username"]) !== false) {
                    echo '<a href="forensic/donaldchall" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">DonaldChall<br/><code>5 Points</code></button></a>'; 
                } else {
                    echo '<a href="forensic/donaldchall" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">DonaldChall<br/><code>5 Points</code></button></a>';
                }
				?>
            </div>
                                                </div>
