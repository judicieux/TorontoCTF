...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/863888673891942460/3201119705_1_2_OIHwjqCk.gif"><br><br><br/><br/><br/><br/><br/>
<a href="getme.txt"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{b64n0ts0str0ng}" || $_POST['flag'] == "b64n0ts0str0ng"){
