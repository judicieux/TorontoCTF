    <meta name="keywords" content="toronto, toronto-challs" /><?php
session_start();
...
if(!in_array($_SESSION["username"], $whitelist)){
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            ...
                            <li>
                                <a style="position: relative;top:20px;"href="#!" onclick="javascript:toggleFullScreen()" class="waves-effect waves-light">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="page-header">
                            <div class="page-block">
                                ...
                                <center><img src="https://media.discordapp.net/attachments/851497771181539348/854091199241256980/standard.gif"></center>
                            </div>
                        </div>
                        <!-- Page-header end -->
                            <!-- Main-body start -->
