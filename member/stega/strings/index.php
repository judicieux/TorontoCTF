...
<center>
<img src="https://cdn.discordapp.com/attachments/851138629899255808/864635201329561610/image0.gif"><br><br><br/><br/><br/><br/><br/>
<a href="strings.jpg"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{inv1s1bl3_fl4g_but_not_4_strings}" || $_POST['flag'] == "inv1s1bl3_fl4g_but_not_4_strings"){
