...
<li class="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Challenges</a>
                                            </li>
                                            </li>
                                            <li class="breadcrumb-item"><a href="#!">Steganography</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-header-left">
                                                            <h5>Steganography Challenges</h5>
                                                        </div>
    ...
    <div class="card-block">
        <?php
			   if(strpos(file_get_contents("stega/strings/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/strings" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Strings<br/><code>5 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/strings" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Strings<br/><code>5 Points</code></button></a>';
            }
			   if(strpos(file_get_contents("stega/extractme/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/extractme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">ExtractMe<br/><code>5 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/extractme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">ExtractMe<br/><code>5 Points</code></button></a>';
            }
            if(strpos(file_get_contents("stega/corruptedimg/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/corruptedimg" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Corrupted Image<br/><code>5 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/corruptedimg" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Corrupted Image<br/><code>5 Points</code></button></a>';
            }
            if(strpos(file_get_contents("stega/findmeisez/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/findmeisez" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">FindMeIsEz<br/><code>5 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/findmeisez" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">FindMeIsEz<br/><code>5 Points</code></button></a>';
            }
            if(strpos(file_get_contents("stega/readmeaudio/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/readmeaudio" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">ReadMe Audio<br/><code>10 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/readmeaudio" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">ReadMe Audio<br/><code>10 Points</code></button></a>';
            }
            if(strpos(file_get_contents("stega/hop02/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/hop02" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">hop02<br/><code>10 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/hop02" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">hop02<br/><code>10 Points</code></button></a>';
            }
			 if(strpos(file_get_contents("stega/getme/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/getme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">GetMe<br/><code>10 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/getme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">GetMe<br/><code>10 Points</code></button></a>';
            }

            if(strpos(file_get_contents("stega/resizeme/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/resizeme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Resize ME<br/><code>15 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/resizeme" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Resize ME<br/><code>15 Points</code></button></a>';
            }
			 if(strpos(file_get_contents("stega/01100011/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/01100011" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">01100011<br/><code>15 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/01100011" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">01100011<br/><code>15 Points</code></button></a>';
            }

            if(strpos(file_get_contents("stega/chainsnow/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/chainsnow" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Chainsnow<br/><code>20 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/chainsnow" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Chainsnow<br/><code>20 Points</code></button></a>';
            }
             if(strpos(file_get_contents("stega/binarypng/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/binarypng" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">BinaryPNG<br/><code>30 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/binarypng" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">BinaryPNG<br/><code>30 Points</code></button></a>';
            }
		     if(strpos(file_get_contents("stega/pit/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/pit" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">PIT<br/><code>35 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/pit" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">PIT<br/><code>35 Points</code></button></a>';
            }
		     if(strpos(file_get_contents("stega/hardvol1/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/hardvol1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Hard Vol1<br/><code>50 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/hardvol1" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Hard Vol1<br/><code>50 Points</code></button></a>';
            }
		     if(strpos(file_get_contents("stega/hardvol2/winners.txt"), $_SESSION["username"]) !== false) {
                echo '<a href="stega/hardvol2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light" style="background-color: #29FB07;border-color: #29FB07">Hard Vol2<br/><code>65 Points</code></button></a>'; 
            } else {
                echo '<a href="stega/hardvol2" style="text-decoration: none;color: #FFFFFF"><button class="btn btn-primary waves-effect waves-light">Hard Vol2<br/><code>65 Points</code></button></a>';
            }
