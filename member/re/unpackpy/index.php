...
<center>
<img src="https://thumbs.gfycat.com/DecisiveApprehensiveImperialeagle-size_restricted.gif"><br><br><br/><br/><br/><br/><br/>
<a href="toronto.exe"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{unp4ck_m3_1f_y0u_c4n}" || $_POST['flag'] == "unp4ck_m3_1f_y0u_c4n"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+40 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 40 WHERE username = '" . $_SESSION["username"] . "'";
