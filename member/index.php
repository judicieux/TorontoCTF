...
$file = fopen("qqdhbqzd.db", "a+");
if($_SESSION['username'] !== "g3zb0yy"){
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index.php">
                                <img class="img-fluid" src="assets/images/logo.png" style="display: inline-block">
                        </a>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center b-b-default">
                                                            <div class="col-sm-6 b-r-default p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/users.png" width="30px" height="30px" />
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/search.png" width="30px" height="30px" />
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <?php
                                                                        $handle = fopen("../../logs/access_ssl_log","r");
																		static $b = 0;
                                                                        ...
                                                                        ?>
                                                                        <h5><?php echo $b; ?></h5>
                                                                        <p class="text-muted m-b-0">Queries</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center">
                                                            <div class="col-sm-6 p-b-20 p-t-20 b-r-default">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/databases.png" width="25px" height="25px" />
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <?php        
																		$directory = "databases/";
                                                                        ...
                                                                        ?>
                                                                        <h5><?php echo $filecount; ?></h5>
                                                                        <p class="text-muted m-b-0">Databases</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/rows.png" width="30px" height="30px" />
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                    <?php
                                                                        $a = system("ls databases/");

                                                                    ?>
                                                                        <h5><?php echo $a; ?></h5>
                                                                        <p class="text-muted m-b-0">Rows</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center b-b-default">
                                                            <div class="col-sm-6 b-r-default p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/database.png" width="30px" height="30px"/>
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <h5>7</h5>
                                                                        <p class="text-muted m-b-0">SQL Databases</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/servers.png" height="30px" height="30px"/>
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <h5>4</h5>
                                                                        <p class="text-muted m-b-0">Servers</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center">
                                                            <div class="col-sm-6 p-b-20 p-t-20 b-r-default">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/challenges.png" width="30px" height="30px"/>
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <h5>43</h5>
                                                                        <p class="text-muted m-b-0">Challenges</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 p-b-20 p-t-20">
                                                                <div class="row align-items-center text-center">
                                                                    <div class="col-4 p-r-0">
                                                                        <img src="assets/images/ping-pong.png" width="30px" height="30px"/>
                                                                    </div>
                                                                    <div class="col-8 p-l-0">
                                                                        <?php
                                                                        ...
                                                                        $ping =  ping("www.alwaysdata.com", 80, 10);
                                                                        $final = $ping + 10;
                                                                        //Echoing it will display the ping if the host is up, if not it'll say "down". 
                                                                        ?>
                                                                        <h5><?php echo $final; ?></h5>
                                                                        <p class="text-muted m-b-0">Ping</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9 cst-cont">
                                                                <?php
                                                                $sql = "SELECT pts FROM users WHERE id = " . $_SESSION["id"];
                                                                $result = mysqli_query($bdd, $sql);
                                                                if (mysqli_num_rows($result)) {
                                                                    while ($row = mysqli_fetch_array($result)) {
                                                                        if(!empty($row['pts'])){
                                                ...
                                                <div class="card mat-clr-stat-card text-white blue">
                                                    <div class="card-block">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9 cst-cont">
															<?php
																$sql2 = "SELECT respects FROM users WHERE username = '" . $bdd->real_escape_string($_SESSION["username"]) . "'";
																$toto = mysqli_query($bdd, $sql2);
																if(mysqli_num_rows($toto)){
																	while($row = mysqli_fetch_array($toto)){
																		
																	?>
                                                                <h5><?php echo $row["respects"]; }} ?></h5>
                                                                <p class="m-b-0">Respects</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<a href='user.php?id=<?php echo $row["id"];?>'>
                                                                                <img src="avatars/<?php echo $row['avatar']; ?>" alt="user image" class="img-radius img-40 align-top m-r-15" width="50" height="40" style='object-fit: cover;'/>
                                                                                <?php
                                                                                } else {
                                                                                ?>
<a href='user.php?id=<?php echo $row["id"];?>'>
                                                                                <img src="avatars/default.png" alt="user image" class="img-radius img-40 align-top m-r-15" width="50" height="40" />
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                                ...
                                                                                ?>
                                                                                    <p class="text-muted m-b-0">Founder</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                ...
                                                                                ?>
                                                                                    <p class="text-muted m-b-0">Co-Founder</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
