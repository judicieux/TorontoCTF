...
<center>
<img src="https://cdn.discordapp.com/attachments/851138620948873256/858822337448640512/6272f2abfd146b656c825fa84428e2c5.gif"><br><br><br/><br/><br/><br/><br/>
<a href="extractme.jpg"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{binwalkisprettyezyouright}" || $_POST['flag'] == "binwalkisprettyezyouright"){
