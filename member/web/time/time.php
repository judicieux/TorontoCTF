...
?>
<?php
    $host = "mysql-timebased.alwaysdata.net";
    $user_mysql = "timebased";
    $password_mysql = "Kaka123.";
    $database = "timebased_timebased";
...
<center><img src="https://thumbs.gfycat.com/EasyIdolizedGander-size_restricted.gif"/></center><br/><br/><br/><br/><br/>
<?php
if(!empty($_GET['id'])){
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{T1m3_1snT_S0_34Zy}" || $_POST['flag'] == "T1m3_1snT_S0_34Zy"){
