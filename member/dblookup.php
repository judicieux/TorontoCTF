                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="">Database Lookup</a>
                                            </li>
                                                    ...
                                                    <form method="POST">
                                                        <div class="card-block tooltip-icon button-list">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Pseudo" title="Enter your name" data-toggle="tooltip" name="pseudo">
                                                            </div>
                                                            <input type="submit" class="btn btn-primary waves-effect waves-light m-r-20" data-toggle="tooltip" data-placement="right" title="submit" name="submit" value="Search">
                                                        </div>
                                                    </form>
                                                    <div class="card-block tooltip-icon button-list">
                                                        <?php
                                                        if (!empty(isset($_POST["submit"])))
                                                        {
                                                            if (isset($_POST["pseudo"]) && strlen($_POST["pseudo"]) >= 3)
                                                            {
                                                                ...
                                                                if(empty($result)){
                                                                    echo "<p style='color:red'>Nothing found.</p>";
                                                                }
                                                            } else {
                                                                echo "<p style='color:red'>Minimum length is 3 characters.</p>";
                                                            }
                                                        }
                                                        ?>
                                                    </div>
