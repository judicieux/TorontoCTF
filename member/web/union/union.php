...
<center><img src="https://i.imgur.com/PPDT2pB.gif"/></center><br/><br/><br/><br/><br/>
<?php
if(!empty($_GET['id'])){
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{Un10N_1S_v3Ry_s1Mpl3}" || $_POST['flag'] == "Un10N_1S_v3Ry_s1Mpl3"){
