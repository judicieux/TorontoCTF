...
<center>
<img src="https://cdn.discordapp.com/attachments/850044358254395392/852532765315301387/readmea.jpg"><br><br><br/><br/><br/><br/><br/>
<a href="t0r0nt0readme.wav"><button class="button button3">Download</button></a><br><br>
</center>
<style>
.button {
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{m3ch4nt}" || $_POST['flag'] == "m3ch4nt"){
