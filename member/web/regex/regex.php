...
<center>
<br>
<img src="https://i.skyrock.net/6596/84286596/pics/3121971371_1_3_2ffuRhko.gif"/><br/><br/>
<br>
<h2 style="color:white">I/O</h3>
<h4 style="color:white">Input: Bonjour txxxxxoxxxxxrxxxxxoxxxxxnxxxxxtxxxxxo, que fais-tu ?</h4>
<h4 style="color:white">Output: toronto</h4><br/>
<?php
...
<form method="POST">
    ...
    <p class="p-container">
        ...
        if(!empty(isset($_POST['submit']))){
            if(isset($_POST['flag']) && $_POST['flag'] == "t0r0nt0_ch4ll{pCr3_R3g3X_1S_s0_N1c3}" || $_POST['flag'] == "pCr3_R3g3X_1S_s0_N1c3"){
                ...
                if(in_array($search, $string)){
                    ...
                    echo "<center><h5 style='color:#20FF33'>+65 POINTS</h5></center>";
                    $host = "mysql-toronto.alwaysdata.net";
                    $user_mysql = "toronto";
                    $password_mysql = "Kaka123.";
                    ...
                    $sql = "UPDATE users SET pts = pts + 65 WHERE username = '" . $_SESSION["username"] . "'";
